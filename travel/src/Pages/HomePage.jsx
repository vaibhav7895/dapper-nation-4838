...
import {Box,Image,SimpleGrid,Text,Container,Button,InputRightElement,} from "@chakra-ui/react";
...
function HomePage() {
  return (
    <>
    <Box w="100%" border="2px solid yellow" backgroundImage="https://media.istockphoto.com/id/155439315/photo/passenger-airplane-flying-above-clouds-during-sunset.jpg?b=1&s=170667a&w=0&k=20&c=0ptevX36IqBQM1P4PoCycpe8Vj-QAhITR7oNn9R991g="
...
function HomePage() {
    return (
        ...
        <Box pt="2%" w={{base:"95%",md:"82%"}} m="auto" >
                ...
                <Box pt="2%" w={{ base: "100%", md: "82%" }} m="auto" >
                    <SimpleGrid columns={{ base: 2, md: 4 }}>
                        ...
                        <Box
                            ...
                            alignItems="center"
                        >
                            <Box w="96%" m="auto" mt={{ base: "85%", md: "100%" }} borderRadius="5%" bgColor="rgba(255, 255, 255, 0.300)" textAlign="left" >
                                <Text color="white" fontWeight="bold" fontSize={{ base: "md", md: "xl" }}>
                                    Light you Journey
                                </Text>
                                <Text color="white" fontWeight="bold" fontSize="sm">Ratings-⭐⭐⭐⭐</Text>
            ...
            <Container mt={{ base: "15%", md: "5%" }} maxW={{ base: "90%", md: "80%" }}>
                <Box display="flex" borderRadius={"2%"} backgroundColor="#1071DB" h={{ base: "400px", md: "600px" }}>
                    ...
                    <Box w="65%">
                        ...
                        <Box w="100%" mt="2%" >
                            <Image w="30%" m="auto" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTqEdHqL1QVzS2zDc5lSt3JT9Tj2ZEuA9N8MCLJ1A7xTg&usqp=CAU&ec=48600113" />
                        </Box>
                        <Box mt="4%">
            ...
            <Box w="85%" m="auto" display="flex" justifyContent="space-between">
      ...
      <Container maxW={"98%"}>
        ...
        <Box>
          <Text
            ...
            color="grey"
            fontWeight={{ base: "bolder", md: "bold" }}
          >
            Explore travels and discover the most popular destinations around
            the world.
          </Text>
        </Box>
        <Box w={{ base: "100%", md: "80%" }} h="100%" pt="3%" m="auto">
          <Box display="flex" w="100%">
            <Box position="relative" m="auto" w={{ base: "50%", md: "50%" }}>
              <Image
                borderRadius={{ base: "8%", md: "5%" }}
                h={{ base: "200px", md: "500px" }}
                src="https://images.unsplash.com/photo-1679401938866-ac2fc3f9f468?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8NDR8fHRvdXJpc3QlMjBwbGFjZXN8ZW58MHx8MHx8&auto=format&fit=crop&w=500&q=60"
                alt="img"
              />
              <Text
                position="absolute"
            ...
            <Box position="relative" m="auto" w={{ base: "23%", md: "23%" }}>
              <Image
                borderRadius={{ base: "8%", md: "5%" }}
                h={{ base: "200px", md: "500px" }}
                src="https://media.istockphoto.com/id/1471503216/photo/mardin-dara-ancient-city-mesopotamia-mardin-turkey-dara-ancient-city-one-of-the-most.jpg?b=1&s=170667a&w=0&k=20&c=F8deNgdF0onytMueyDB6Q88ObYaxQZtksr34qTq22-E="
                alt=""
              />
              <Text
                position="absolute"
            ...
            <Box position="relative" m="auto" w={{ base: "23%", md: "23%" }}>
              <Image
                borderRadius={{ base: "8%", md: "5%" }}
                h={{ base: "200px", md: "500px" }}
                src="https://media.istockphoto.com/id/1383383546/photo/arc-de-triomphe-illuminated-by-the-morning-light.jpg?b=1&s=170667a&w=0&k=20&c=QdVMpa-SFLYExFTlbJnHw2ACeeXfYMYJE6duOXeUO_8="
                alt=""
              />
              <Text
                position="absolute"
          ...
          <Box display="flex" mt="2%" w="100%">
            <Box position="relative" m="auto" w={{ base: "23%", md: "24%" }}>
              <Image
                borderRadius={{ base: "8%", md: "5%" }}
                h={{ base: "200px", md: "500px" }}
                src="https://media.istockphoto.com/id/1364745633/photo/rear-view-of-a-woman-with-a-hat-while-shes-admiring-an-ancient-temple-in-sicily.jpg?b=1&s=170667a&w=0&k=20&c=P3K0L6x7siEDuHS7LbI92g2yodCENvrTd3hSkeiMmZg="
                alt=""
              />
              <Text
                position="absolute"
            ...
            <Box position="relative" m="auto" w={{ base: "23%", md: "24%" }}>
              <Image
                borderRadius={{ base: "8%", md: "5%" }}
                h={{ base: "200px", md: "500px" }}
                src="https://media.istockphoto.com/id/1324189687/photo/arc-de-triomphe-from-the-sky-paris.jpg?b=1&s=170667a&w=0&k=20&c=njR3Id6dAMM5XtTUdxTov4yWfTAjVn6w10YucDfeUJY="
                alt=""
              />
              <Text
                position="absolute"
            ...
            <Box position="relative" m="auto" w={{ base: "46%", md: "47.5%" }}>
              <Image
                borderRadius={{ base: "8%", md: "5%" }}
                h={{ base: "200px", md: "500px" }}
                src="https://media.istockphoto.com/id/547499548/photo/big-ben-and-westminster-bridge-at-sunset.jpg?b=1&s=170667a&w=0&k=20&c=cTM51AKuVmpYZLY7AuF3Z7Ore86Cj3ODkSh0p58u7Cs="
                alt="img"
              />
              <Text
                position="absolute"
        ...
        <Box>
          <Text
            ...
            fontWeight={{ base: "bolder", md: "bold" }}
          >
            Escape the ordinary and embark on an unforgettable adventure with
            us.
          </Text>
        </Box>
        ...
        >
          <Box w="80%" p="5.5%">
            ...
            <Text
              ...
              color="white"
            >
              Welcome to Travels, the ultimate destination for travelers seeking
        ...
        <SimpleGrid columns={{ base: 1, md: 2 }}>
          ...
          >
            <Image
              w="100%"
              height={{ base: "250px", md: "400px" }}
              src="https://media.istockphoto.com/id/618431030/photo/3d-business-travel-concept.jpg?s=612x612&w=0&k=20&c=koBQ9JHIW1okP15gzsM8hk8bQXVtxKiJcT9Cwd9hFvg="
            />
          </Box>
              ...
              <Box display="flex" m="auto">
                <Box w="15%" m="auto" h="110px">
                  <Image
                    borderRadius={"50%"}
                    h={{ base: "60px", md: "80px" }}
                    src="https://images.unsplash.com/photo-1483546363825-7ebf25fb7513?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MzN8fGNhcnR0b24lMjBib29rfGVufDB8fDB8fA%3D%3D&auto=format&fit=crop&w=500&q=60"
                  />
                </Box>
                <Box w="80%">
                  <Text
                  ...
                  <Text
                    ...
                    textAlign={"left"}
                  >
                    Welcome to Travels, your home away from home! We're
                    committed to providing you with the best possible experience
                    during your stay,whether you're traveling for business or
                    pleasure.{" "}
                  </Text>
                  <Text></Text>
                </Box>
              ...
              <Box display="flex" m="auto" h="">
                <Box w="15%" m="auto" h="110px">
                  <Image
                    borderRadius={"50%"}
                    h={{ base: "60px", md: "80px" }}
                    src="https://images.unsplash.com/photo-1617704548623-340376564e68?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8Mnx8VmVoaWNsZSUyMHNlcnZpY2V8ZW58MHx8MHx8&auto=format&fit=crop&w=500&q=60"
                  />
                </Box>
                <Box w="80%">
                  <Text
                  ...
                  <Text
                    ...
                    textAlign={"left"}
                  >
                    Welcome to Travels, your premier destination for top-quality
                    vehicles services! At Travels, we're committed to providing
              ...
              <Box display="flex" m="auto" h="">
                <Box w="15%" m="auto" h="110px">
                  <Image
                    borderRadius={"50%"}
                    h={{ base: "60px", md: "80px" }}
                    src="https://media.istockphoto.com/id/1252748149/photo/cartoon-airplane.jpg?s=612x612&w=0&k=20&c=knbEDdr79P5gHsHo1QCokjfrvIuUhuKVPR1PaLN-Iwo="
                  />
                </Box>
                <Box w="80%">
                  <Text
                  ...
                  <Text
                    ...
                    textAlign={"left"}
                  >
                    Welcome to Travels, your one-stop shop for booking flights
                    to destinations all around the world! Our easy-to-use
                    booking system makes it simple to find the perfect flight
...
{/* Follow US On INstagram PArt Starts Here------------------------------------------------------------------------------- Follow US On INstagram PArt Starts Here------------------------------------------------------------------------------- Follow US On INstagram PArt Starts Here------------------------------------------------------------------------------- Follow US On INstagram PArt Starts Here------------------------------------------------------------------------------- Follow US On INstagram PArt Starts Here------------------------------------------------------------------------------- */}
        ...
        >
          <Box w="35%" m={{ base: "auto" }}>
            <Image
              ...
              src="https://images.unsplash.com/photo-1611791484670-ce19b801d192?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MTQ2fHxQaG9uZXxlbnwwfHwwfHw%3D&auto=format&fit=crop&w=500&q=60"
            />
          </Box>
          ...
          <Box w="65%">
            ...
            <Text color="#fff" fontSize={{ base: "xs", md: "sm" }}>
              We offer a wide selection of apps to choose from, including
              popular social media apps, entertainment apps, reliable, and easy
              to use.
            </Text>
            ...
            <Box w="100%" mt="2%">
              <Image
                w="40%"
                m="auto"
                src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTqEdHqL1QVzS2zDc5lSt3JT9Tj2ZEuA9N8MCLJ1A7xTg&usqp=CAU&ec=48600113"
              />
            </Box>
            <Box mt="4%">
              <Image
                m="auto"
                src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT-nevWmK-q0BBvAFyIiOYSvAyGLZqRDHwJX7mAOrdRXg&usqp=CAU&ec=48600113"
              />
            </Box>
          </Box>
        </Box>
          ...
          <SimpleGrid columns={{ base: 2, md: 4 }}>
            ...
            >
              ...
              >
                ...
                <Text color="white" fontWeight="bold" fontSize="xs">
                  The layout of the travel blog merely serves to emphasize the
                  atmospheric{" "}
                  <Text
            ...
            >
              ...
              >
                ...
                <Text color="white" fontWeight="bold" fontSize="xs">
                  This is all good for beginners but grow, most bloggers forgot
                  design
                  <Text
                    fontSize={{ base: "xs", md: "xs" }}
                    fontWeight="bold"
            ...
            >
              ...
              >
                ...
                <Text color="white" fontWeight="bold" fontSize="xs">
                  Travel blogs nowadays starting look all generic off
                  <Text
                    fontSize={{ base: "xs", md: "xs" }}
                    fontWeight="bold"
                    color="#0C264C"
       ...
       <Box m="auto" backgroundColor="#1071DB" w="100%" border="1px solid green"  height="700px">
            ...
            >
              ...
              >
                ...
                <Text color="white" fontWeight="bold" fontSize="xs">
                  Did you know that you can startblog for as low as 3 USD per
                  month?{" "}
                  <Text
                    fontSize={{ base: "xs", md: "xs" }}
                    fontWeight="bold"
      ...
      <Container mt="8%" maxW={{ base: "90%", md: "85%" }}>
        ...
        <Box display="flex" justifyContent={"space-between"}>
          ...
          >
            Our official Instagram account is the perfect place to catch a
        ...
        <SimpleGrid mt="3%" columns={{ base: 2, md: 4 }}>
          ...
          >
            <Image
              ...
              w={{ base: "160px", md: "270px" }}
              height={{ base: "240px", md: "400px" }}
              src="https://plus.unsplash.com/premium_photo-1663011082727-15235d691976?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MXx8YmVhY2glMjBpbWFnZXN8ZW58MHx8MHx8&auto=format&fit=crop&w=500&q=60"
            />
          </Box>
          <Box
            m="2%"
          ...
          >
            <Image
              ...
              w={{ base: "160px", md: "270px" }}
              height={{ base: "240px", md: "400px" }}
              src="https://images.unsplash.com/photo-1520483601560-389dff434fdf?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MTd8fGJlYWNoJTIwaW1hZ2VzfGVufDB8fDB8fA%3D%3D&auto=format&fit=crop&w=500&q=60"
            />
          </Box>
          <Box
            m="2%"
          ...
          >
            <Image
              ...
              w={{ base: "160px", md: "270px" }}
              height={{ base: "240px", md: "400px" }}
              src="https://images.unsplash.com/photo-1509233725247-49e657c54213?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8M3x8YmVhY2glMjBpbWFnZXN8ZW58MHx8MHx8&auto=format&fit=crop&w=500&q=60"
            />
          </Box>
          <Box
            m="2%"
          ...
          >
            <Image
              ...
              w={{ base: "160px", md: "270px" }}
              height={{ base: "240px", md: "400px" }}
              src="https://images.unsplash.com/photo-1584704876450-0eb3fd5a2f65?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MTJ8fGJlYWNoJTIwaW1hZ2VzfGVufDB8fDB8fA%3D%3D&auto=format&fit=crop&w=500&q=60"
            />
          </Box>
          ...
          >
            <Image
              ...
              w={{ base: "160px", md: "270px" }}
              height={{ base: "240px", md: "400px" }}
              src="https://images.unsplash.com/photo-1618338279109-d470da3999ed?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8M3x8aW5zdGFncmFtJTIwcG9zdHxlbnwwfHwwfHw%3D&auto=format&fit=crop&w=500&q=60"
            />
          </Box>
          <Box
            m="2%"
          ...
          >
            <Image
              ...
              w={{ base: "160px", md: "270px" }}
              height={{ base: "240px", md: "400px" }}
              src="https://media.istockphoto.com/id/1288271580/photo/social-media-and-digital-online-concept-woman-using-smartphone.jpg?b=1&s=170667a&w=0&k=20&c=iknpSLP2cHCMTvk_y77JBSunErsEzD-ZMUMKHwkFBNY="
            />
          </Box>
          <Box
            m="2%"
          ...
          >
            <Image
              ...
              w={{ base: "160px", md: "270px" }}
              height={{ base: "240px", md: "400px" }}
              src="https://images.unsplash.com/photo-1608725131946-c73a151f2f8a?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MTB8fGluc3RhZ3JhbSUyMHBvc3R8ZW58MHx8MHx8&auto=format&fit=crop&w=500&q=60"
            />
          </Box>
          <Box
            m="2%"
          ...
          >
            <Image
              ...
              w={{ base: "160px", md: "270px" }}
              height={{ base: "240px", md: "400px" }}
              src="https://images.unsplash.com/photo-1584900524480-87624a1ba59c?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MjB8fGJlYWNoJTIwaW1hZ2VzfGVufDB8fDB8fA%3D%3D&auto=format&fit=crop&w=500&q=60"
            />
          </Box>
        </SimpleGrid>
      </Container>
